...
<div class="property-card">
    ...
    <div class="p-5 flex-col gap-3">
        ...
        <div class="mt-5 flex justify-normal gap-0" v-if="parentView === 'LISTING'">
            <router-link :to="{ name: 'EditListing', params: { merchantId: form.merchant_id, id: form.id } }" class="text-white-900 bg-[#27AAC4] hover:bg-[#27AAC4]/90 focus:ring-4 focus:outline-none focus:ring-[#27AAC4]/50 font-medium rounded-lg text-sm px-2.5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#27AAC4]/50 mr-1 mb-2">
            ...
            <router-link :to="{ name: 'CreateProduct', params: {listingCategoryId: form.id}}"  type="button" class="text-gray-900 bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-4 focus:outline-none focus:ring-[#F7BE38]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#F7BE38]/50 mr-1 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
