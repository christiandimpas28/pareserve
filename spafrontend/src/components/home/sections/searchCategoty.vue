...
const search = (param) => {
    ...
    const price_start = ''; // encodeURIComponent(param.end)  
    const price_end = ''; // encodeURIComponent(param.end)  
    router.push({ name: 'ListingsSearch', query: { query: val, start: start, end: end, price_start: price_start, price_end: price_end } })
}
